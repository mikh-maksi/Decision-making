...
# Create dummy date
tasks = ['Аналіз ЦА', 'Планування ', 'Підготовка до розробки', 'Найм співробітників', 'Фронт ', 'Бек ', 'Тестування ', 'Наповнення ' ,'Реліз ']
start_dates = ['2024-09-01', '2024-09-03', '2024-09-06', '2024-09-07','2024-09-10', '2024-09-12', '2024-09-15', '2024-09-19', '2024-09-20']
end_dates = ['2024-09-03', '2024-09-06', '2024-09-07', '2024-09-10','2024-09-12', '2024-09-15', '2024-09-19', '2024-09-20', '2024-09-21']
...
task_colors = [colors[0]] * 4 + [colors[1]] * 3 + [colors[2]] * 2
...
legend_elements = [
    Patch(facecolor=colors[0], label='Підготовка'),
    Patch(facecolor=colors[1], label='Розробка'),
    Patch(facecolor=colors[2], label='Наповнення та реліз'),
]
